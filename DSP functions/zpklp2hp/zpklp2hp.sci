...
//                      p = roots(a);
//                      k = b(1);
//                      [z2,p2,k2] = zpklp2hp(z,p,k,0.5,0.35);
//
...
//Input Validaton Statement
    ...
    if argn(1) <1 | argn(1)>5 then
        error("Number of output arguments should be between 1 to 5");
    end
